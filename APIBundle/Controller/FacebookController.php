...
class FacebookController extends Controller {
    ...
    public function facebookButtonAction($facebookUserHandleRoute, $permissions, $cssClass = '', $linkText = '') {
        ...
        return $this->render('APIBundle:Facebook:facebookLink.html.twig', array('dialog_url' => $dialog_url, 'cssClass' => $cssClass, 'text' => $linkText));
    }
    ...
    public function endDialogAction() {
        ...
        if (isset($error)) {
            ...
            return $this->render('APIBundle:Facebook:facebookCloseWindow.html.twig', array('url' => $this->generateUrl($facebookUserHandleRoute, array(), true)));
        }
    }
